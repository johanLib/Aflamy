...
<body style="background-color: #f5f5fe;">
    ...
    <div class="right-links">
        ...
        <a href="watching.php" style="color: #763BC9;">Watching</a>
    ...
    <main style="margin: 5rem 0; text-align: center;">
        <h1 id="heading-title" style="margin-bottom: 1.5em;">Watching List</h1>
        <div class="movies-container">
            <?php
                $user_id = $_SESSION['id'];
                $movies = "SELECT Poster, Title, Rating FROM watching WHERE user_id = '$user_id'";
